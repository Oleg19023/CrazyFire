...
document.addEventListener("DOMContentLoaded", () => {
    ...
    const footerHTML = `
        <footer id="footer" style="display: none;">
            <p class="footer-text"><img src="/assets/images/Site-logos/4kLogo2.png" alt="logo" class="footer-logo">© 2023-<span id="footerYear"></span> <b>CrazyFire сorporation. Все права защищены.</b> Заставка CrazyFire, Логотип CrazyFire, являются товарными знаками или зарегистрированными товарными знаками CrazyFire в Украине и остальных странах.</p>  
            ...
            <div>
                <div class="footer-bottom">
                    ...
                    <h6 class="m-3">
                        <a class="update-button" href="/Info-pages/update-history.html">Update v2.5dev</a> | <span id="footerDate"></span> | <span id="footerTime"></span>
                    </h6>
                </div>
            </div>
        </footer>
