...
const particlesConfig = {
                ...
                "autoPlay": true,
                                ...
                                "interactivity": {
                                        ...
                                        "events": {
                                                ...
                                                "onHover": {
                                                        "enable": true, // Movement
                                                        "mode": "grab", // Change mod
                                                        "parallax": {
                                                                "enable": true,
                                                                "force": 100, // Motion force
                                                                "smooth": 30 // Smooth movement
                                                        }
                                                },
                                                "resize": {
                                                        "delay": 0.5,
                                        ...
                                        "modes": {
                                                ...
                                                "push": {
                                                        "default": true,
                                                        "groups": [],
                                                        "quantity": 4 // Number of points created when pressed
                                                },
                                                "remove": {
                                                        "quantity": 2 // 
                                                },
                                ...
                                "particles": {
                                        ...
                                        "number": {
                                                ...
                                                "limit": {
                                                        "mode": "delete",
                                                        "value": 400 // Max limit particles
                                                },
                                                "value": 200 // Particles for start
                                        },
                                        "opacity": {
                                                "value": {
                                                        "min": 0.1,
    ...
    let isParticlesEnabled = localStorage.getItem('isParticlesEnabled') === 'true';
    
    // При загрузке страницы проверяем состояние и устанавливаем иконку
    ...
    document.getElementById('parallaxToggle').addEventListener('click', function () {
        const parallaxIcon = document.getElementById('parallaxIcon');
        if (isParticlesEnabled) {
        ...
        localStorage.setItem('isParticlesEnabled', isParticlesEnabled);
    });